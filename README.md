...
Для цієї інформації додаємо пакет:
poetry add pytest-cov -G test

Згенерувати файли з даними про покриття тестами:
pytest --cov=. --cov-report html tests/

Далі слід відкрити файл main_py.html (статичний файл) з папки htmlcov у браузері.
